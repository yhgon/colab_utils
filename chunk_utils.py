...
def data_step1(filename, prefix='librivox_chunk_', max_len=1, work_dir = '/content/'):
    ...
    with open(filename, 'r') as f_handle:
        ...
        for line in f_handle:
            ...
            chunk_step1_v2(data=this_data, sr=22050, chunk_top_db=10, chunk_frame_length=512, chunk_hop_length=32, csv_filename=str_filename_output_csv_ext, query_value=0.24)            
            i += 1
